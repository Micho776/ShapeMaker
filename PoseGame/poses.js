...
const POSES = [
    ...
    // 3. THE BOLT ( Diagonal Arms )
    { name: "THE BOLT", points: [{name:"nose",x:0.1,y:-0.5},{name:"left_shoulder",x:0.25,y:-0.35},{name:"right_shoulder",x:-0.25,y:-0.35},{name:"left_elbow",x:0.4,y:-0.5},{name:"right_elbow",x:-0.1,y:-0.3},{name:"left_wrist",x:0.6,y:-0.6},{name:"right_wrist",x:0.1,y:-0.35},{name:"left_hip",x:0.15,y:0.15},{name:"right_hip",x:-0.15,y:0.15},{name:"left_knee",x:0.15,y:0.5},{name:"right_knee",x:-0.15,y:0.5},{name:"left_ankle",x:0.15,y:0.85},{name:"right_ankle",x:-0.15,y:0.85}]},
